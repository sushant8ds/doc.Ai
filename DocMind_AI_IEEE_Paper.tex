...
\begin{equation}
  ...
  \label{eq:chunk}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:chunk}.}
The notation $T[a:b]$ denotes the substring of $T$ from character
...
\begin{equation}
  ...
  \label{eq:nchunks}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:nchunks}.}
...
\begin{equation}
  ...
  \label{eq:pagelabel}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:pagelabel}.}
...
\begin{equation}
  ...
  \label{eq:embed}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:embed}.}
...
\begin{equation}
  ...
  \label{eq:embmat}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:embmat}.}
...
\begin{equation}
  ...
  \label{eq:retrieval}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:retrieval}.}
...
\begin{equation}
  ...
  \label{eq:l2}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:l2}.}
...
\begin{equation}
  ...
  \label{eq:prompt}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:prompt}.}
...
\begin{equation}
  ...
  \label{eq:gen}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:gen}.}
...
\begin{equation}
  ...
  \label{eq:nucleus}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:nucleus}.}
...
\begin{equation}
  ...
  \label{eq:halluc}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:halluc}.}
...
\begin{equation}
  ...
  \label{eq:gr}
\end{equation}
\textbf{Explanation of Eq.~\eqref{eq:gr}.}
